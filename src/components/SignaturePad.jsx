  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 4 }}>
        ...
        {hasInk && (
          <button type="button" onClick={clear} style={{ background: "none", border: "none", color: "var(--accent-orange-dark)", fontSize: 13, cursor: "pointer", padding: 0 }}>
      ...
      <canvas
        ...
        style={{
          ...
          border: `1px solid ${hasInk ? "var(--accent-orange)" : "var(--border)"}`,
